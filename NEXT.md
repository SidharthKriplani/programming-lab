...
**B2 (pandas → 41) + B3 (Python drills → 56) at interview scope — SHIPPED 2026-06-23**, 337 checks independently verified. 120 problems total. Next: B4 (idioms + the judgment dial/MCQ layer), and **worker-hardening (A-PL-01) is now urgent** — heavy pandas runs on the main thread will jank the UI. Four-frame KNOW/BUILD/JUDGE spec expansion still paper-only.
