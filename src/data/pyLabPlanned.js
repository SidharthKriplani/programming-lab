...
//
// KNOW/DO SEAM (D-PL-22, see docs/FOUNDATIONS-SPEC.md §9): the plan-sys-* /
// plan-async-* / plan-n2s-* stub categories below are the DO companions (graded
// exercises) to foundationsRooms.js rooms — plan-async-* <-> room 5 (Concurrency
// & Parallelism), plan-n2s-* <-> room 6 (Shipping Python: Notebook -> Service),
// plan-sys-* <-> rooms 8 (The Metal) + 2 (The Machine). Same topics on both
// surfaces is BY DESIGN — the KNOW room installs the model, the DO stub drills
// it. There is ONE Foundations map (foundationsRooms.js); these are its shadows.
